package main.java.by.epam.pronovich.homework01.task01;

import main.java.by.epam.pronovich.homework01.task01.service.EmployeeService;
import main.java.by.epam.pronovich.homework01.task01.service.PositionService;
import main.java.by.epam.pronovich.homework01.task01.service.SalaryService;
import main.java.by.epam.pronovich.homework01.task01.entity.Position;
import org.springframework.context.ApplicationContext;
import org.springframework.context.support.ClassPathXmlApplicationContext;
import static main.java.by.epam.pronovich.homework01.task01.entity.Level.SENIOR;
...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext ctxService = new ClassPathXmlApplicationContext("homework01/task01/Services.xml");
        ApplicationContext ctxPos = new ClassPathXmlApplicationContext("homework01/task01/Position.xml");
